...
🔻حساسیت ضداسپم [عدد] 👈 عددی از 5 تا 20
🔻فیلتر کردن [کلمه] 👈 ممنوع کردن یک کلمه در گروه
🔻حذف فیلتر [کلمه] 👈 حذف کلمه فیلتر شده
🔻لیست فیلتر 👈 کلمات فیلتر شده گروه
🔻سکوت [یوزرنیم|ایدی|ریپلی] 👈 ساکت کردن کاربر
🔻سکوت [یوزرنیم|ایدی|ریپلی] [دقیقه] 👈 ساکت کردن زمان دار
...
🔹لیست مدیران 
🔹قفل کردن [گروه|اعضا|انگلیسی|چت|متن|استیکر|گیف|عکس|فیلم|صدا|فایل|مخاطبین|تبلیغات|تگ|سیستم|کانال]
🔹باز کردن [گروه|اعضا|انگلیسی|چت|متن|استیکر|گیف|عکس|فیلم|صدا|فایل|مخاطبین|تبلیغات|تگ|سیستم|کانال]
🔹فعال کردن [خوشامد|ابزارها|فیلترینگ|ضداسپم|سکسی]
🔹غیرفعال کردن [خوشامد|ابزارها|فیلترینگ|ضداسپم|سکسی]
🔹عکس تصادفی گروه 
🔹ثبت [قوانین|موضوع|خوشامد|لینک|نام]
...
🔹لیست ربات 👈 ربات های درون گروه
🔹ایدی 👈 ایدی عددی کاربر با ریپلی
🔹ایدی [یوزرنیم|عددی] 👈 نمایش ایدی یک یوزرنیم
🔹دسترسی عمومی [خاموش|روشن]
🔹اطلاعیه <متن> 👈 پیام با تگ تمام گروه
...
🔸لیست دیتا 👈 نمایش تمام عناوین ذخیره شده
🔸حذف لیست دیتا 👈 حذف تمام عناوین
🔸ایجاد نظرسنجی [متن] 👈 ذخیره یک نظرسنجی
🔸نظرسنجی [عدد] 👈 شرکت در نظرسنجی
🔸نظرسنجی 👈 نمایش آمار نظرسنجی
🔸ابزارها 👈 نمایش لیست ابزارهای ربات
🔸لیست گروه ها 👈 نمایش گروه های عمومی
🔸پیغام به [ایدی گروه] [متن] 👈 ارسال پیام به سایر گروه ها
